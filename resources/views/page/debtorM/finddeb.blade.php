...
<div class="col-12">
    <div class="card mb-4">
        <div class="card-header pb-0">
            ...
            @if ($deb3->count() > 0)
            <button type="button" class="btn bg-gradient-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" disabled>
                เพิ่มรายการยอดค้าง
            </button>
            @else
            ...
            <button type="button" class="btn bg-gradient-success" data-bs-toggle="modal" data-bs-target="#exampleModalRemark">
                รายการ
            </button>
            ...
            <div class="modal fade" id="exampleModalRemark" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                <a href="{{ url('/remark/delete/' . $item->id) }}" class=" btn btn-danger" onclick="return confirm('ลบหรือไม่ ?')">
                                                                    ลบข้อมูล</a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#exampleModalEdit{{ $item->id }}" disabled>
                            <i class="fas fa-edit"></i>
                        </button>
                        @else
                        <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#exampleModalEdit{{ $item->id }}">
                            <i class="fas fa-edit"></i>
                        </button>
                        @endif
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="{{ url('/debtors-m/store/update/' . $item->id) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="row">
                                                <div class="col-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="debtors_name" style="color: black; font-weight: bold;" value="{{ $item->total_price }}" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="date" name="created_at" value="{{ date('Y-m-d', strtotime($item->created_at)) }}" style="color: black; font-weight: bold;">
                                                ...
                                                <div class="col-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="date" name="end_date" value="{{ $item->end_date }}" style="color: black; font-weight: bold;">
                                                    </div>
                                                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('payment.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="hidden" class="form-control" name="debt_rounds_id" value="{{ $deb5->id }}">
                    <input type="hidden" class="form-control" name="debt_id" value="{{ $deb5->debt_id }}">
                    <input type="hidden" class="form-control" id="exampleFormControlInput1" name="amount_d" value="{{ $totalint }}">
                    <button type="button" class="btn bg-gradient-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="submit" class="btn bg-gradient-primary">Save
                        changes</button>
                </form>
...
<div class="modal fade" id="exampleModalDD" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
        ...
        <div class="card-header pb-0">
            <div class="row">
                <div class="col-12" style=" display: flex;">
                    ...
                    <form action="{{ url('/debtors-m/update/money/' . $deb5->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf

                        @if ($deb8)
                        @if ($deb2->count() <= 0) <input type="hidden" name="round_amount" value="{{ $deb8->total_price }}">
                            @else
                            <input type="hidden" name="round_amount" value="{{ $deb8->amount }}">
                            @endif


                            @if ($deb2->count() <= 0) <input type="hidden" class="form-control" name="round_interest" value="{{ $totalint }}">
                                @else
                                <input type="hidden" class="form-control" name="round_interest" value="{{ $totalAmountD }}">
                                @endif


                                <button type="submit" class="btn bg-gradient-danger" style="margin-right: 10px" onclick="return confirm('ปรับปรุงยอดหรือไม่ ?')">ปรับปรุงยอด</button>
                                @else
                                <button type="submit" class="btn bg-gradient-danger" style="margin-right: 10px" onclick="return confirm('ปรับปรุงยอดหรือไม่ ?')" disabled>ปรับปรุงยอด</button>
                                @endif
                    ...
                    <form id="myForm" action="{{ url('/debtors-m/update/final/' . $deb5->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf

                        <input type="password" class="form-control" id="confirmation_code" name="confirmation_code" placeholder="กรอกรหัสยืนยัน" style="margin-bottom: 10px; color: rgb(2, 2, 2); font-weight: 1000;font-size: 18px;">

                        @if ($deb5->status == 'complete')
                        <button type="submit" class="btn bg-gradient-dark" disabled onclick="return customConfirm()">ปิดบิล</button>
                        @else
                        <button type="submit" class="btn bg-gradient-dark" onclick="return customConfirm()">ปิดบิล</button>
                        @endif
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    @if ($deb8)
                    @if ($deb2->count() <= 0) <h4>จำนวนเงินต้น ติดค้างคงเหลือ: {{ $deb8->total_price }} บาท
                        <span>

                            <button type="button" class="btn bg-gradient-success" data-bs-toggle="modal" data-bs-target="#exampleModalDebtors">
                                เงินต้น
                            </button>
                        </span>
                        <div class="modal fade" id="exampleModalDebtors" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            ...
                                            <div class="card-header pb-0">
                                                ...
                                                <div class="row">
                                                    <div class="col-12" style=" display: flex;">
                                                        ...
                                                        <button type="button" class="btn bg-gradient-primary" data-bs-toggle="modal" data-bs-target="#exampleModal1" disabled>
                                                            เพิ่มการจ่ายเงินต้น
                                                        </button>
                        ...
                        <h4>จำนวนเงินต้น ติดค้างคงเหลือ: {{ $deb8->amount }} บาท
                            <span>
                                ...
                                <button type="button" class="btn bg-gradient-warning" data-bs-toggle="modal" data-bs-target="#exampleModalDebtors">
                                    เงินต้น
                                </button>
                            </span>
                            <div class="modal fade" id="exampleModalDebtors" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="col-6">
                    ...
                    @if ($deb2->count() <= 0) <h4>จำนวนดอกเบี้ยติดค้างคงเหลือ: {{ $totalint }}
                        <span>

                            <button type="button" class="btn bg-gradient-danger" data-bs-toggle="modal" data-bs-target="#exampleModalDebtorsV2">
                                ดอกเบี้ย
                            </button>
                        </span>
                        <div class="modal fade" id="exampleModalDebtorsV2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        @else
                        <h4>จำนวนดอกเบี้ยติดค้างคงเหลือ: {{ $totalAmountD }}
                            <span>
